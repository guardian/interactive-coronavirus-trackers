...
var getParallel = async function() {
    ...
    fs.writeFileSync('../interactive/assets/timestamp.json', JSON.stringify(timestamp));
    fs.writeFileSync('../interactive/assets/confirmed.json', JSON.stringify(data, null, 2));
